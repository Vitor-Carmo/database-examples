...
/*
	...
	que custem acima do valor médio dos produtos em estoque
*/
...
/*
	...
	(o que define um produto mais caro??? lembrando que está no plural , então não é O mais caro, e sim OS mais caroS.
	peguei a media e chamei os que estão acima, pois, pra mim isso define o que seria os mais caros.
	não sei se é o certo a se fazer. achei um pouco ambiguo a questão (ou minha interpretação de texto não é tão boa assim))
*/
